...
a b testing in TypeScript.

## 🚀 Overview
This repository contains a professional implementation of **TypeScript A B Testing**. It is designed with clean code principles and focuses on functionality and reliability.
